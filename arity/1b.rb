# EXPERIMENT 1a — bisect_1 with call() removed from input_fields (table selector inlined)
# ================================================
    ...
    get_table: {
      ...
      input_fields: lambda do |_object_definitions|
        [{
            ...
            hint: 'Select or map the table to retrieve.'
          }]
      end,
