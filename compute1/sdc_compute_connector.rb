    ...
    supplier_user: {
      fields: lambda do |_connection, _config_fields, _object_definitions|
        [
          ...
          { name: 'primary', type: 'boolean', control_type: 'checkbox', label: 'Primary', hint: 'true / 1 / yes / y / t are all read as true' },
    ...
    plan_primary_user_change: {
      ...
      input_fields: lambda do |object_definitions|
        [
          ...
          { name: 'move_task', type: 'boolean', control_type: 'checkbox', optional: true, label: 'Move task to new primary', hint: 'Default true. (Was read but never declared in the Python step.)' },
    ...
    plan_user_migration: {
      ...
      input_fields: lambda do |object_definitions|
        [
          ...
          { name: 'will_reseed', type: 'boolean', control_type: 'checkbox', optional: true, label: 'This run re-seeds', hint: 'true when INC-01 runs after this step' },
          { name: 'requests', type: 'array', of: 'object', optional: true, label: 'Requests', properties: object_definitions['supplier_request'] },
