...
Design rules encoded here (violating one is a design bug, not a style choice):
  ...
  4. `snapshot_id` is accepted everywhere and defaults to latest. M1 only
     uses latest; the parameter exists so M2 diffing needs no signature change.
...
TOOLS = [
    ...
    },
    {
        ...
        "returns": {
            ...
            "edges_from_step": [
                {"kind": "str", "dst_type": "str", "dst_name": "str", "resolved": "bool"}
            ],
        },
    },
    {
        ...
        "description": (
            ...
            "dst_type='recipe'. Rows where resolved=false are known export "
            "degradations (target id present, name unresolvable) — report them, "
            "don't drop them."
        ),
        "parameters": {
            "type": "object",
            "properties": {
                ...
                "dst_id": {"type": "string", "description": "Filter: exact destination id."},
                "dst_name_contains": {
                    "type": "string",
    ...
    },
    {
        ...
        "description": (
            ...
            "that mentions a schema version."
        ),
        "parameters": {
            "type": "object",
            "properties": {
