...
// --- Corpus Q&A ---------------------------------------------------------------------------------------
/** ***UPDATED*** Interim ask box (O2) until the web-app UI lands. */
...
/** ***UPDATED*** Manual digest rebuild (the same build cron_digest runs nightly, fingerprint-gated). */
function rebuildCorpusDigest() {
  Commands.run("corpus.digest");
}
/** ***UPDATED*** Opens the Q&A sidebar: ask box, rendered cited answers, recent history from Output_QA_Log. */
