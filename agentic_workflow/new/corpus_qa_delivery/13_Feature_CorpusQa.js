 ...
 *   no agent loop. At ~58 recipes the whole estate fits one Gemini context; retrieval at this scale is
 *   a new way to be wrong. The single seam for the future is CorpusQaService.loadContext_() — today it
 *   returns the whole digest, someday it may return selected blocks. The answerer never changes.
 *
 ...
 *
 *   Provenance chain: sheet -> digest -> answer, unbroken. Every ask leaves an audit row in System_Logs.
 */
