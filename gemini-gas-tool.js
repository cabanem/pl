...
/**
 * The ONLY place that touches GeminiLib. If your library's public method has a
 * different name or shape, change just this function \u2014 nothing else depends on it.
 * (Adjust the method name and key names to match your GeminiLib's public API.)
 */
function callGemini_(cfg, prompt) {
  return GeminiLib.generate({
    prompt:      prompt,
    system:      cfg.system_instruction,
    model:       cfg.model,
