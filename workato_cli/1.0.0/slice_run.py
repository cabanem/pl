...
# The oracle: STS-01's facts transcribed from the OpenAPI spec's rows
# (x-data-tables / x-status-writers). Single source — imported by fetch_selftest
# and real_oracle so all three diff against the same answer key.
ORACLE = {
